...
import com.github.invictum.reportportal.StepDataExtractorsHolder;
...
public class SerenityPortalModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(StepDataExtractorsHolder.class).toProvider(StepProcessorsHolderProvider.class).in(Scopes.SINGLETON);
